...
String url = "http://vml3730.wdf.sap.corp:8003/sap/bc/ina/demos/epm/search.html";
...
try{
	...
	driver.findElement(By.cssSelector("#xs_password-inner")).sendKeys("manager");
